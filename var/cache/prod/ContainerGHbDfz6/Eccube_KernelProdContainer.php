...
class Eccube_KernelProdContainer extends Container
{
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $h = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [(\dirname(__DIR__, 4).'/app/Plugin/EntityExtension/Entity')]);
        $h->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $i = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [(\dirname(__DIR__, 4).'/app/Plugin/EntityForm/Entity')]);
        $i->setTraitProxiesDirectory((\dirname(__DIR__, 4).'/app/proxy/entity'));
        $j = new \Eccube\Doctrine\ORM\Mapping\Driver\AnnotationDriver($f, [(\dirname(__DIR__, 4).'/app/Plugin/MigrationSample/Entity')]);
        ...
        $e->addDriver($h, 'Plugin\\EntityExtension\\Entity');
        $e->addDriver($i, 'Plugin\\EntityForm\\Entity');
        $e->addDriver($j, 'Plugin\\MigrationSample\\Entity');
    ...
    protected static function getSecurity_Firewall_MapService($container)
    {
        ...
        return $container->privates['security.firewall.map'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($a, new RewindableGenerator(function () use ($container) {
            ...
            yield 'security.firewall.map.context.admin' => ($container->privates['.security.request_matcher.HoCoXeB'] ?? $container->load('get_Security_RequestMatcher_HoCoXeBService'));
